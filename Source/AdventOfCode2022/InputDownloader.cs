...
public class InputDownloader : IDisposable
{
    ...
    public void DownloadDay(int day)
    {
        ...
        if (!day.IsWithin(1, 25) || File.Exists(inputFilePath) || _httpClientHandler == null || DateTime.Today < new DateTime(2021, 12, day))
        {
            return;
        }
        ...
        try
        {
            ...
            var input = httpClient.GetStringAsync($"https://adventofcode.com/2022/day/{day}/input").Result;
