namespace AdventOfCode2022.Generator;
...
public class Program
{
    ...
    private static void CreateDailyProblemCodeFiles(int year)
    {
        ...
        try
        {
            ...
            {
                var pathToProblemFile = Path.Combine("Source", "AdventOfCode2022", "Problems", $"Problem{day}.cs");
                var pathToProblemTestFile = Path.Combine("Source", "AdventOfCode2022.Tests", "Problems", $"Problem{day}Tests.cs");
